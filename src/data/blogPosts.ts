...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      'Executive Summary  
The rise of AI-powered search transforms how people find information online. Instead of scanning lists of links, users ask AI direct questions and receive concise answers. This shift signals the decline of traditional SEO and t...',
    readTime: '5 min',
    source: 'notion',
  ...
  },
  {
    ...
    excerpt:
      'Executive Summary  
The 2026 third-party cookie deprecation forces organizations to own legal compliance and data consent. Marketers must pivot to cookieless attribution methods, incrementality testing, and marketing mix modeling (MMM). First-part...',
    readTime: '5 min',
    source: 'notion',
  ...
  },
  {
    ...
    excerpt:
      'Executive Summary  
Over half of UK and US content professionals now use AI to accelerate creative production. However, the greatest evolution in Meta advertising for 2026 is not the creative itself, but targeting strategy. Manual interest stackin...',
    readTime: '5 min',
    source: 'notion',
  ...
  },
  {
    ...
    excerpt:
      'Executive Summary  
The SaaSpocalypse signals a monumental shift from traditional software to AI-driven, agentic workflows. By the end of 2026, 40% of applications will integrate task-specific AI agents that drive continuous outcomes. Marketing le...',
    readTime: '5 min',
    source: 'notion',
  ...
  },
  {
    ...
    excerpt:
      'Executive Summary  
OpenAI’s GPT-5.4 raises the bar with a 1 million token context window and enhanced native coding capabilities. Google’s Gemini 2.5 Pro and Anthropic’s Claude 4.5 battle for dominance across real-world benchmarks. The future of ...',
    readTime: '5 min',
    source: 'notion',
  ...
  },
  {
    ...
    excerpt:
      'Executive Summary  
Marketing leaders in 2026 face new challenges measuring incremental revenue due to privacy changes and cookie deprecation. Media Mix Modeling (MMM), combined with experimental incrementality data, fills critical measurement gap...',
    readTime: '5 min',
    source: 'notion',
  ...
  },
  {
    ...
    excerpt:
      'Executive Summary  
Privacy and trust remain nonnegotiable pillars of consumer relationships in the digital age. AI enables brands to scale micro-moments of trust by personalizing interactions at unprecedented levels. However, navigating the uncan...',
    readTime: '5 min',
    source: 'notion',
  ...
  },
  {
    ...
    excerpt:
      'Executive Summary  
AI-driven advertising transforms paid social media across Meta, Google, and Amazon. By 2026, digital ads will claim 69% of global ad spend, with AI agents autonomously managing media buying workflows. This article explores how ...',
    readTime: '5 min',
    source: 'notion',
  ...
  },
  {
    ...
    excerpt:
      'Executive Summary  
AI transforms marketing by eliminating poor positioning, not jobs. Success depends on marketers who can clearly define goals for AI agents to execute. The future favors those who design effective systems over those who simply u...',
    readTime: '5 min',
    source: 'notion',
